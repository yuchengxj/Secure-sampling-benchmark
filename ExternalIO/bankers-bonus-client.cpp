...
void one_run(T value, Client& client)
{
    ...
    // cout << value << endl;
    client.send_private_inputs<T>({value});
...
int main(int argc, char** argv)
{
    ...
    case 'p':
    {
        ...
        run_estimation<gfp, gfp>(data_path, client);
        break;
    }
    case 'R':
    {
        ...
        {
        case 64:
            run_estimation<Z2<64>, Z2<64>>(data_path, client);
            break;
        case 104:
            run_estimation<Z2<104>, Z2<64>>(data_path, client);
            break;
        case 128:
            run_estimation<Z2<128>, Z2<64>>(data_path, client);
            break;
        default:

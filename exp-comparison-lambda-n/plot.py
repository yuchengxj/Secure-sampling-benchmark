...
def plot_appendix():
    ...
    import pickle
    with open('exp-comparison-lambda-n/logs-bmr/data-and.pkl', 'rb') as f:
        new_data = pickle.load(f)
    new_log_files.append('exp-comparison-lambda-n/logs-bmr/trans_lap.log')
    ...
    for file in new_log_files:
        ...
        file = file.replace('exp-comparison-lambda-n', 'exp')
